...
function olivewp_typography_custom_css() {
    ...
    if($olivewp_enable_content_typo == true) { ?>
        <style>
            ...
            body .entry-content p, body .blog-author p, body .comment-section p, body .comment-form p, body .woocommerce-product-details__short-description p, body .page-section-full p, body input, body textarea, body select, body.woocommerce-page p {
